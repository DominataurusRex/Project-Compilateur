...
{
       0,    34,    34,    43,    51,    55,    61,    68,    72,    75,
      82,    92,   103,   108,   111,   121,   131,   139,   146,   153,
     156,   164,   167,   172,   183,   199,   210,   215,   219,   220,
     221,   223,   228,   230,   235,   237,   243,   245,   251,   253,
     259,   261,   267,   269,   274,   278,   279,   283,   287,   291,
     298,   299,   302,   306
};
#endif
...
#line 1353 "obj/tpc.tab.c"
    break;

  case 8: /* DeclFoncts: DeclFonct  */
#line 72 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1359 "obj/tpc.tab.c"
    break;
...
#line 1408 "obj/tpc.tab.c"
    break;

  case 13: /* Parametres: ListTypVar  */
#line 108 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1414 "obj/tpc.tab.c"
    break;
...
#line 1478 "obj/tpc.tab.c"
    break;

  case 19: /* DeclVarsInt: %empty  */
#line 153 "src/tpc.y"
                                                    {(yyval.node) = makeNode(DeclVars);}
#line 1484 "obj/tpc.tab.c"
    break;
...
#line 1585 "obj/tpc.tab.c"
    break;

  case 28: /* Instr: RETURN ';'  */
#line 219 "src/tpc.y"
                                                    {(yyval.node) = makeNode(Return);}
#line 1591 "obj/tpc.tab.c"
    break;

  case 29: /* Instr: '{' SuiteInstr '}'  */
#line 220 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[-1].node);}
#line 1597 "obj/tpc.tab.c"
    break;

  case 30: /* Instr: ';'  */
#line 221 "src/tpc.y"
                                                    {(yyval.node) = NULL;}
#line 1603 "obj/tpc.tab.c"
    break;
...
#line 1613 "obj/tpc.tab.c"
    break;

  case 32: /* Exp: TB  */
#line 228 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1619 "obj/tpc.tab.c"
    break;
...
#line 1629 "obj/tpc.tab.c"
    break;

  case 34: /* TB: FB  */
#line 235 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1635 "obj/tpc.tab.c"
    break;
...
#line 1646 "obj/tpc.tab.c"
    break;

  case 36: /* FB: M  */
#line 243 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1652 "obj/tpc.tab.c"
    break;
...
#line 1663 "obj/tpc.tab.c"
    break;

  case 38: /* M: E  */
#line 251 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1669 "obj/tpc.tab.c"
    break;
...
#line 1680 "obj/tpc.tab.c"
    break;

  case 40: /* E: T  */
#line 259 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1686 "obj/tpc.tab.c"
    break;
...
#line 1697 "obj/tpc.tab.c"
    break;

  case 42: /* T: F  */
#line 267 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1703 "obj/tpc.tab.c"
    break;
...
#line 306 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1792 "obj/tpc.tab.c"
    break;


#line 1796 "obj/tpc.tab.c"
