...
static const yytype_int16 yyrline[] =
{
     ...
     169,   177,   180,   187,   196,   208,   217,   224,   231,   237,
     238,   240,   245,   247,   252,   254,   260,   262,   268,   270,
     276,   278,   286,   288,   293,   297,   298,   304,   310,   316,
     325,   326,   329,   333
};
#endif
...
#line 1608 "obj/tpc.tab.c"
    break;

  case 29: /* Instr: '{' SuiteInstr '}'  */
#line 237 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[-1].node);}
#line 1614 "obj/tpc.tab.c"
    break;

  case 30: /* Instr: ';'  */
#line 238 "src/tpc.y"
                                                    {(yyval.node) = NULL;}
#line 1620 "obj/tpc.tab.c"
    break;
...
#line 1630 "obj/tpc.tab.c"
    break;

  case 32: /* Exp: TB  */
#line 245 "src/tpc.y"
                                                    {(yyval.node) = (yyvsp[0].node);}
#line 1636 "obj/tpc.tab.c"
    break;
